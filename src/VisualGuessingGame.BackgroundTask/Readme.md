...
Execute unit tests
```
    cd "VisualGuessingGame.BackgroundTask/test/VisualGuessingGame.BackgroundTask.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "VisualGuessingGame.BackgroundTask/src/VisualGuessingGame.BackgroundTask"
